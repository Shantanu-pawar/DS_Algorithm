...
public class j_non_repeating_char {

    static String FirstNonRepeatingUsingQueue(String st){
...
// case 4 : if queue become's emplty then you dont have non repeating char's
    ...
    public static void main(String[] args) {
        String str = FirstNonRepeatingUsingQueue("aadfeddbc");
        FirstNonRepeatingUsingFreqArr("aadfeddbc");

        System.out.println(str);

    }
    static String FirstNonRepeatingUsingFreqArr(String st){
